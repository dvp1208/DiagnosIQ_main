    ...
    def __call__(self, sample):
        ...
        if 'seg_label' in sample.keys():
            try:
                ...
                rotated_label = K.geometry.transform.warp_perspective(label,  self.rotate.transform_matrix, dsize=(H, W), mode='nearest')
            except TypeError:
                rotated_label = K.geometry.transform.warp_perspective(label, self.rotate.transform_matrix, dsize=(H, W))#, flags='nearest')
                #rotated_label = K.geometry.transform.warp_perspective(label, self.rotate, dsize=(H, W), flags='nearest')
